...
public class App 
{
	public static String account = "yll1223514819@163.com";			//替换为发件人账号
    public static String password = "Yll1223514819";					//替换为发件人账号密码
    
    public static String receiveMailAccount = "yll1223514819@163.com";	//替换为收件人账号
